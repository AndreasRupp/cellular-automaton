...
%  of size 500 pixels in one direction. In the created image, black pixels 
%  correspond to the non-zero entries of geo, while white pixels correspond#
%  to the zero entries of geo.
