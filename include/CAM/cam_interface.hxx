...
namespace CAM
{
template <auto nx, typename fields_array_t = std::array<CAM::fieldNumbers, CAM::n_fields<nx>()>>
class CAMInterface
{
   ...
   ~CAMInterface(){}
    ...
    void placeSphere(double _jump_parameter = 1, unsigned int _random_seed = 0){domain.placeSphere(_jump_parameter, _random_seed);}
